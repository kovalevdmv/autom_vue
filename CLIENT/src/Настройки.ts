...
const ТипСклада: КонфигурацияСущности = {
    Имя: "ТипСклада",
...
const Склад: КонфигурацияСущности = {
    Имя: "Склад",
    ТаблицаБД: СкладБД,
    ДопПоля: [
...
const Проекты: КонфигурацияСущности = {
    Имя: "Проекты",
    ТаблицаБД: ПроектыБД,
    ПредставлениеСписка: {
        Компонента: СписокУниверсальный,
...
const Номенклатура: КонфигурацияСущности = {
    Имя: "Номенклатура",
...
const АналогиНоменклатуры: КонфигурацияСущности = {
...
const РаботаСБД: КонфигурацияСущности = {
    Имя: "РаботаСБД",
    ПредставлениеСписка: {
