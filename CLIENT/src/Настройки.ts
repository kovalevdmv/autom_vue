...
const НоменклатураБД = new ТаблицаВБД('nomenclatures');
НоменклатураБД.ДобавитьКолонку("id").Тип(ТипыКолонок.INTEGER).НеNull().АвтоИнкремент();
...
НоменклатураБД.ДобавитьКолонку("main_warehouse").Тип(ТипыКолонок.INTEGER);
...
const АналогиБД = new ТаблицаВБД('analoguesOfNomenclature');
...
const ТипСкладаБД = new ТаблицаВБД('type');
...
const ТипСклада: КонфигурацияТаблицыБД = {
    Имя: "ТипСклада",
...
const СкладБД = new ТаблицаВБД('sklad');
...
const Склад: КонфигурацияТаблицыБД = {
    Имя: "Склад",
    ТаблицаБД: СкладБД,
    ДопПоля: [
        { Поле: "type.name as _type", Связь: "type_id = type.id", Таблица: 'sk1' },
        { Поле: "name as name2", Обработка: _ => _.toUpperCase() },
    ],
    ПредставлениеСписка: {
        Компонента: СписокУниверсальный,
...
const ПроектыБД = new ТаблицаВБД('projects');
...
const Проекты: КонфигурацияТаблицыБД = {
    Имя: "Проекты",
    ТаблицаБД: ПроектыБД,
    ПредставлениеСписка: {
        Компонента: СписокУниверсальный,
...
const Номенклатура: КонфигурацияТаблицыБД = {
    Имя: "Номенклатура",
...
const АналогиНоменклатуры: КонфигурацияТаблицыБД = {
...
const РаботаСБД: КонфигурацияТаблицыБД = {
    Имя: "РаботаСБД",
    ПредставлениеСписка: {
...
const ГлавноеМеню: ГлавныйИнтерфейс = {

    Элементы: [
        {
            Представление: "Номенклатура",
            КонфигурацияТаблицыБД: Номенклатура
        },
        {
            Представление: "Аналоги",
            КонфигурацияТаблицыБД: АналогиНоменклатуры
        },
        {
            Представление: "Склад",
            КонфигурацияТаблицыБД: Склад
        },
        {
            Представление: "Тип cклада",
            КонфигурацияТаблицыБД: ТипСклада
        },
        {
            Представление: "Проекты",
            КонфигурацияТаблицыБД: Проекты
        },
        {
            Представление: "Работа с БД",
            КонфигурацияТаблицыБД: РаботаСБД
        }]
