...
//ПроектыБД.ДобавитьКолонку("mon_id").Тип(ТипыКолонок.INTEGER).ЭтоВнешнийКлюч(true, НоменклатураБД, 'id', ДействияПриИзмененииГлавнойВнешнейТаблицы.НетДействия, ДействияПриИзмененииГлавнойВнешнейТаблицы.Ограничивать);
