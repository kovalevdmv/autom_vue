...
export const АналогиНоменклатуры: КонфигурацияСущности = {
    ...
    ДопПоля: [
        { Поле: "goods.name as goods", Связь: "nomenclature_id = goods.id" },
        { Поле: "goods2.name as analogue", Связь: "analogue_id = goods2.id", Таблица: 'goods' },
    ],
    ПредставлениеСписка: {
        Компонента: СписокУниверсальный,
        Заголовок: "Аналоги",
    ...
    ПодчиненныеТаблицы: [
        {
            ...
            ДопПоля: [{ Поле: 'goods1.name as goods_name1', Связь: "goods_id = goods1.id", Таблица: 'goods' }],
            КлючГлавнойТаблицы: 'id',
            КолонкаСВнешнимКлючемВПодчиненнойТаблице: 'purchase_of_goods_id',
            ПредставлениеСписка: ПриобретениеТоваровТаблицаТоваров.ПредставлениеСписка,
        }]
};
...
export default { ТипСклада, Склад, Проекты, Номенклатура, АналогиНоменклатуры, ПриобретениеТоваровТаблицаТоваров, ПриобретениеТоваров, РаботаСБД };