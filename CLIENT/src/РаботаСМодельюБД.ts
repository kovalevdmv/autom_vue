...
class Колонка {
    ...
    ПолучитьЗначенияПолей() {
        return { Тип: this._Тип, Имя: this._Имя, ПризнакНеNull: this._ПризнакНеNull, ЗначениеПоУмолчанию: this._ЗначениеПоУмолчанию, ПризнакЭтоПервичныйКлюч: this._ПризнакЭтоПервичныйКлюч, ДанныеВнешнегоКлюча: this._ДанныеВнешнегоКлюча, АвтоИнкремент: this._АвтоИнкремент, Индексируется: this._Индексируется, Синоним: this._Синоним  };
    }

    constructor(Имя: string, Синоним: string = '') {
        this._Имя = Имя;
        this._Синоним = Синоним;
    }
...
class ТаблицаВБД {
    ...
    Колонка(Имя: string, Синоним: string = '') {
        const НоваяКолонка = new Колонка(Имя, Синоним);
